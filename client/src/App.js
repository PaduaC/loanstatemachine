...
import LoanStateMachine from "./contracts/LoanStateMachine.json";
...
function App() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      const deployedNetwork = LoanStateMachine.networks[networkId];
      const contract = new web3.eth.Contract(
        LoanStateMachine.abi,
  ...
  return (
    <div className="container">
      ...
      {/* make it visible only for borrower, when state is active, and when loan is finished */}
